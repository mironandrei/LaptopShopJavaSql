...
The database was made in ***[Microsoft SQL Server 2014 Management Studio](https://www.microsoft.com/en-us/download/details.aspx?id=42299)*** and here I uploaded the backup of the database ***[ProiectBDMiron.bak](https://github.com/mironandrei/LaptopShopJavaSql/blob/main/ProiectBDMiron.bak)***. Type ***ALTER AUTHORIZATION ON DATABASE::ProiectBDMiron TO sa*** in a query and execute if you want to see the database diagram. Also you can see the structure of the tables in the documentation above.
